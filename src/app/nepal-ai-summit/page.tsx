      ...
      <main>
        ...
        <section className="relative min-h-[65vh] flex items-center justify-center bg-gray-900 text-white">
          <div className="absolute inset-0">
            <Image
              src="/images/events/AISummit.jpg"
              alt="NAIS event"
              fill
          ...
          <div className="relative z-10 mx-auto max-w-6xl px-6 text-center">
            <div className="flex flex-col items-center gap-6">
              ...
              <p className="max-w-3xl text-lg text-gray-200">
                NAIS 2026 is a flagship national conference designed to bring together policymakers, industry leaders, researchers, startups, investors, and global experts to advance Nepal’s AI ecosystem.
              </p>

              <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
                <a
                  href="https://nepal-ai.org"
