          ...
          <div className="relative z-10 mx-auto max-w-6xl px-6 text-center">
            <div className="flex flex-col items-center gap-6">
              ...
              <p className="max-w-3xl text-lg text-gray-200">
                Dedicated to digital innovation and economic development in the Madhesh region. Promoting entrepreneurship and inclusive growth through technology-driven solutions.
              </p>
